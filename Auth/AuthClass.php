   ...
   { 
     ...
     { 
       ...
       { 
         ...
         $hashPasswd = hash_Passwd($password, PASSWORD_DEFAULT); 

         //Masukkan user baru ke database 

         $stmt = $this->db->prepare("INSERT INTO tbAuth(nama, username, password) VALUES(:nama, :uername, :pass)"); 
		 ...
		 $stmt->bindparam(":admin,petugas,manajer", $admin,$petugas,$manajer);
