...
<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/login/css/tampilan.css">
  <!-- Font Awesome -->
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url();?>index.php/login/do_login" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="username" id="nama_user" placeholder="Username" required/>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="password" id="pass_user" placeholder="Password" required/>
